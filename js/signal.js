const SIG_IMG_DIR = '/webclient/images/signals/';
...
function Signal(jsonObj)
{
    ...
    sig.id = this.htmlID;
    sig.src = SIG_IMG_DIR + this.type + '_' + this.mainAspect + '_' + (this.routeSet ? 'SET' : 'UNSET') + '.png';
...
Signal.prototype.update = function()
{
    ...
    this.domElement.src = SIG_IMG_DIR + this.type + '_' + this.mainAspect + '_' + (this.routeSet ? 'SET' : 'UNSET') + '.png';
};
