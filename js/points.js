const PTS_IMG_DIR = '/webclient/images/points/';
...
function Points(jsonObj)
{
    ...
    pts.id = this.htmlID;
    pts.src = PTS_IMG_DIR + this.images[this.dataValue] + '.png';
...
Points.prototype.update = function()
{
    ...
    this.domElement.src = PTS_IMG_DIR + this.images[this.dataValue] + '.png';
