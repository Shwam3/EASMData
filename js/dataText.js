function DataText(jsonObj)
{
    ...
    this.text = [];
    this.text[0] = typeof jsonObj['text0'] !== 'undefined' ? escapeHTML(jsonObj['text0']).replace('\\n','<br/>') : undefined;
    this.text[1] = typeof jsonObj['text1'] !== 'undefined' ? escapeHTML(jsonObj['text1']).replace('\\n','<br/>') : undefined;
